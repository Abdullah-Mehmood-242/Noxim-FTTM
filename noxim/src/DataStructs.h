...
// Task Definition for FTTM
struct Task {
    int task_id;
    int instruction_count;
    map<int, int> communication_partners; // partner_id -> volume

    Task() : task_id(-1), instruction_count(0) {}
    Task(int id, int instructions) : task_id(id), instruction_count(instructions) {}
};
